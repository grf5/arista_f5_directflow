...
/**
  ...
  */
ilx.addMethod('createDirectflowEntryv6', function(req, res) {
	directflow.createDirectflowEntryv6(req.params()[0], req.params()[1], req.params()[2], req.params()[3], req.params()[4], req.params()[5], function(result) {
